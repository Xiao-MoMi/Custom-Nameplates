...
public abstract class BukkitCommandFeature<C extends CommandSender> extends AbstractCommandFeature<C> {
    ...
    public BukkitCommandFeature(CustomNameplatesCommandManager<C> commandManager, BukkitCustomNameplates plugin) {
    ...
    protected SenderFactory<?, C> getSenderFactory() {
        return (SenderFactory<?, C>) BukkitCustomNameplates.getInstance().getSenderFactory();
    }
