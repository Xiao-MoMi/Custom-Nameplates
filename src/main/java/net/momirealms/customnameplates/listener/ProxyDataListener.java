...
import net.momirealms.customnameplates.objects.team.TABbcHook;
...
public class ProxyDataListener implements PluginMessageListener {
    ...
    private final TABbcHook taBbcHook;

    public ProxyDataListener(TABbcHook taBbcHook) {
        this.taBbcHook = taBbcHook;
    }
