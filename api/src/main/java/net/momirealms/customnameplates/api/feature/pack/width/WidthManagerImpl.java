...
public class WidthManagerImpl implements WidthManager {
    ...
    private void init() {
        this.templateConfigConsumersMap.put("unifont", (id, path) -> {
            ...
            registerCharacterFontData(id, unifontCache);
        });
        ...
        this.templateConfigConsumersMap.put("ascii", (id, path) -> {
                ...
                try {
                    ...
                    for (String line : new String[]{
                        ...
                        for (char c : chars) {
                            ...
                            yml.set(CharacterUtils.native2ascii(c), charWidth);
                            i++;
                        }
                        j++;
                    }
            ...
            registerCharacterFontData(id, asciiCache);
        });
        ...
        this.templateConfigConsumersMap.put("ascii-sga", (id, path) -> {
            ...
            registerCharacterFontData(id, asciiSgaCache);
        });
        ...
        this.templateConfigConsumersMap.put("asciillager", (id, path) -> {
            ...
            registerCharacterFontData(id, asciillagerCache);
        });
        ...
        this.templateConfigConsumersMap.put("accented", (id, path) -> {
            ...
            registerCharacterFontData(id, accentedCache);
        });
        ...
        this.templateConfigConsumersMap.put("nonlatin-european", (id, path) -> {
                        ...
                        for (int z = 0; z < chars.length; z++) {
                            ...
                            if (Character.isHighSurrogate(c1)) {
                                if (z + 1 < chars.length && Character.isLowSurrogate(chars[z+1])) {
                                    char c2 = chars[++z];
                                    unicode = CharacterUtils.native2ascii(c1) + CharacterUtils.native2ascii(c2);
                                } else {
                                    throw new IllegalArgumentException("Illegal surrogate character");
                                }
                            } else {
                                unicode = CharacterUtils.native2ascii(c1);
                            }
                            int width = bufferedImage.getWidth();
                            int single = width / 16;
                            int x_final = i * single;
            ...
            registerCharacterFontData(id, nonlatinEuropeanCache);
        });
        ...
        this.templateConfigConsumersMap.put("unicode", (id, path) -> {
            ...
            registerCharacterFontData(id, unicodeCache);
        });
    ...
    private void registerCharacterFontData(String id, File asciiCache) {
