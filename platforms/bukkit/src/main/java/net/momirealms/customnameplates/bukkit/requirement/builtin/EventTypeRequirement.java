...
public class EventTypeRequirement extends AbstractRequirement {

    private final String eventType;

    public EventTypeRequirement(int refreshInterval, String eventType) {
    ...
    public boolean isSatisfied(CNPlayer p1, CNPlayer p2) {
        return p1.isEventActive(eventType);
    }
    ...
    public boolean equals(Object o) {
        ...
        EventTypeRequirement that = (EventTypeRequirement) o;
