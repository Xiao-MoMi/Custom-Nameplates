...
public class DisguiseTypeRequirement extends AbstractRequirement {

    private final Set<String> types;

    public DisguiseTypeRequirement(int refreshInterval, Set<String> types) {
    ...
    public boolean isSatisfied(CNPlayer p1, CNPlayer p2) {
        ...
        if (!DisguiseUtils.isDisguised((Player) p1.player())) return false;
    ...
    public boolean equals(Object object) {
        ...
        DisguiseTypeRequirement that = (DisguiseTypeRequirement) object;
