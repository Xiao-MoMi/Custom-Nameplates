...
public class NameplatesForceUnEquipCommand extends BukkitCommandFeature<CommandSender> {

    public NameplatesForceUnEquipCommand(CustomNameplatesCommandManager<CommandSender> commandManager, BukkitCustomNameplates plugin) {
    ...
    public String getFeatureID() {
        return "nameplates_force_unequip";
    }
}
