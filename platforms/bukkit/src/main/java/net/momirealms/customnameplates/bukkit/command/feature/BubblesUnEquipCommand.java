...
public class BubblesUnEquipCommand extends BukkitCommandFeature<CommandSender> {

    public BubblesUnEquipCommand(CustomNameplatesCommandManager<CommandSender> commandManager, BukkitCustomNameplates plugin) {
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(context -> {
                    ...
                    if (player.bubbleData().equals("none")) {
