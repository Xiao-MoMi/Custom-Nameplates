...
public class DebugWidthCommand extends BukkitCommandFeature<CommandSender> {
    ...
    public DebugWidthCommand(CustomNameplatesCommandManager<CommandSender> commandManager, BukkitCustomNameplates plugin) {
    ...
    public Command.Builder<? extends CommandSender> assembleCommand(CommandManager<CommandSender> manager, Command.Builder<CommandSender> builder) {
        return builder
                ...
                .handler(context -> {
                    ...
                    context.sender().sendMessage(String.valueOf(plugin.getAdvanceManager().getLineAdvance(text)));
                });
    }
