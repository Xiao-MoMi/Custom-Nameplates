...
public class NotWorldRequirement extends AbstractRequirement {

	private final Set<String> worlds;

	public NotWorldRequirement(int refreshInterval, List<String> worlds) {
	...
	public boolean equals(Object o) {
		...
		NotWorldRequirement that = (NotWorldRequirement) o;
